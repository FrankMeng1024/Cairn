...
const RELEASE_URL = 'https://github.com/FrankMeng1024/Cairn/releases/download/unity-xcframework-latest/UnityFramework.xcframework.zip';
...
try {
  ...
  console.error('  https://github.com/FrankMeng1024/Cairn/releases/tag/unity-xcframework-latest');
  process.exit(1);
}
...
function writePodsspec() {
  ...
  s.homepage         = 'https://github.com/FrankMeng1024/Cairn'

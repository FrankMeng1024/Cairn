...
const runStyles = StyleSheet.create({
  ...
  compassRing: {
    ...
    borderWidth: 3, borderColor: 'rgba(93,124,70,0.4)',
    alignItems: 'center', justifyContent: 'center',
    backgroundColor: 'rgba(93,124,70,0.08)',
    gap: Spacing.xs,
  },
  compassArrow: { fontSize: 72, color: Colors.primary },
  compassDir: { fontSize: FontSize.caption, color: 'rgba(255,255,255,0.5)' },
  ...
  tapDots: { flexDirection: 'row', gap: Spacing.sm, marginTop: 4 },
  tapDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: 'rgba(255,255,255,0.2)' },
  tapDotActive: { backgroundColor: Colors.primary },

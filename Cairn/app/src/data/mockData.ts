...
export const MOCK_MARKERS = [
  { id: '1', type: 'danger'   as MarkerType, text: '路面湿滑，注意脚下', author: 'Sam', minutesAgo: 45, x: 0.3, y: 0.4 },
  { id: '2', type: 'scenic'   as MarkerType, text: '绝美火山口，值得停留', author: 'Mika', minutesAgo: 120, x: 0.6, y: 0.35 },
  { id: '3', type: 'supply'   as MarkerType, text: '干净水源，可直接饮用', author: 'Yuki', minutesAgo: 300, x: 0.45, y: 0.65 },
];
